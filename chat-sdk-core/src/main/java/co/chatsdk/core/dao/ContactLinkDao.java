...
/** 
 * DAO for table "CONTACT_LİNK".
*/
public class ContactLinkDao extends AbstractDao<ContactLink, Long> {

    public static final String TABLENAME = "CONTACT_LİNK";
    ...
    public static class Properties {
        ...
        public final static Property LinkOwnerUserDaoId = new Property(2, Long.class, "linkOwnerUserDaoId", false, "LİNK_OWNER_USER_DAO_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CONTACT_LİNK\" (" + //
                "\"_id\" INTEGER PRIMARY KEY ," + // 0: id
                "\"USER_ID\" INTEGER," + // 1: userId
                "\"LİNK_OWNER_USER_DAO_ID\" INTEGER," + // 2: linkOwnerUserDaoId
                "\"TYPE\" INTEGER NOT NULL );"); // 3: type
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CONTACT_LİNK\"";
        db.execSQL(sql);
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM CONTACT_LİNK T");
