...
/** 
 * DAO for table "USER_THREAD_LİNK".
*/
public class UserThreadLinkDao extends AbstractDao<UserThreadLink, Long> {

    public static final String TABLENAME = "USER_THREAD_LİNK";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER_THREAD_LİNK\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"USER_THREAD_LİNK\"";
        db.execSQL(sql);
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM USER_THREAD_LİNK T");
