...
public class ThreadDao extends AbstractDao<Thread, Long> {
    ...
    public static class Properties {
        ...
        public final static Property CreationDate = new Property(2, java.util.Date.class, "creationDate", false, "CREATİON_DATE");
        ...
        public final static Property CreatorEntityId = new Property(7, String.class, "creatorEntityId", false, "CREATOR_ENTİTY_ID");
        public final static Property ImageUrl = new Property(8, String.class, "imageUrl", false, "İMAGE_URL");
        public final static Property RootKey = new Property(9, String.class, "rootKey", false, "ROOT_KEY");
        public final static Property ApiKey = new Property(10, String.class, "apiKey", false, "APİ_KEY");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"THREAD\" (" + //
                ...
                "\"CREATİON_DATE\" INTEGER," + // 2: creationDate
                "\"HAS_UNREAD_MESSAGES\" INTEGER," + // 3: hasUnreadMessages
                "\"DELETED\" INTEGER," + // 4: deleted
                "\"NAME\" TEXT," + // 5: name
                "\"TYPE\" INTEGER," + // 6: type
                "\"CREATOR_ENTİTY_ID\" TEXT," + // 7: creatorEntityId
                "\"İMAGE_URL\" TEXT," + // 8: imageUrl
                "\"ROOT_KEY\" TEXT," + // 9: rootKey
                "\"APİ_KEY\" TEXT," + // 10: apiKey
