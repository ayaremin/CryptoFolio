...
/** 
 * DAO for table "READ_RECEİPT_USER_LİNK".
*/
public class ReadReceiptUserLinkDao extends AbstractDao<ReadReceiptUserLink, Long> {

    public static final String TABLENAME = "READ_RECEİPT_USER_LİNK";
    ...
    public static class Properties {
        ...
        public final static Property ReadReceiptId = new Property(1, long.class, "readReceiptId", false, "READ_RECEİPT_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"READ_RECEİPT_USER_LİNK\" (" + //
                "\"_id\" INTEGER PRIMARY KEY NOT NULL ," + // 0: id
                "\"READ_RECEİPT_ID\" INTEGER NOT NULL ," + // 1: readReceiptId
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"READ_RECEİPT_USER_LİNK\"";
        db.execSQL(sql);
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM READ_RECEİPT_USER_LİNK T");
